...
#define PURE_FUNC HEDLEY_PURE

#define RETURNS_ERROR [[nodiscard("Must handle returned Error")]]

#define FN_PURE PURE_FUNC

/// The function has no side-effects, and the return value depends only on the
/// parameters. Note that pointer arguments are not allowed.
#define CONST_FUNC HEDLEY_CONST

#define FN_CONST CONST_FUNC
